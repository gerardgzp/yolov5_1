...
# 路径
# 源图像存储的目录：
org_images_dir = r'data/nosplit/images'
# 源标签存储的目录（图像和标签的名称必须一一对应）：
org_labels_dir = r'data/nosplit/labels'
# 输出的目标路径：
...
is_output_yaml = True
# 若输出yaml文件，必须提供类的信息
classes = ["0 Satisfaction","20 Satisfaction","30 Satisfaction","30 Satisfaction","100 Satisfaction","80 Satisfaction","40 Satisfaction","60 Satisfaction"]  # class names
